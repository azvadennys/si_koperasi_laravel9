@extends('admin.layout', ['active' => __('simpananwajib')])
                ...
                <div class="card z-index-0 fadeIn3 fadeInBottom mb-5">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                            <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Tambah Simpanan Wajib</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form method="post" action="{{ route('simpananwajib.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="input-group input-group-static mb-4">
                                <label>Jumlah</label>
                                <input type="number" name='jumlah' class="form-control" value="25000" readonly required
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('simpananwajib.index') }}"
